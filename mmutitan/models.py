...
# MOVED TO TOP: Defined before User so relationships map correctly
...
class Task(db.Model):
    ...
    # MOVED INSIDE CLASS: Properly linked to the Task model
    user_tasks = db.relationship('UserTask', backref='task_ref', cascade="all, delete-orphan", lazy=True)
